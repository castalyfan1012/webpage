        ...
        <FullPageWrapper enabled={!isMobile}>
            ...
            <Section>
                <div className="mx-auto w-[82%] max-w-screen-2xl grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden">
                    ...
                    {/* MOBILE IMAGE — FIXED CROPPING */}
                    <motion.div
                        className="block md:hidden col-span-1 mx-auto my-10"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}>
                        <div className="rounded-full h-72 w-72 mx-auto overflow-hidden grayscale-3 hover:grayscale-0 transition-all ease duration-300">
                            <Image
                                src={Me}
                                width={500}
                                height={500}
                    ...
                    <motion.div
                        ...
                        <motion.p
                            ...
                            Hi, welcome to Castaly&apos;s homepage. I am a Physics PhD candidate specializing in high-energy physics, with a current focus on neutrino physics using Machine Learning (ML) and data-driven analysis. My research spans cosmology, astrophysics, and high-energy theoretical physics, bridging fundamental science with cutting-edge experimental techniques. Explore the pages below to learn more about my work and interests.
                        </motion.p>
